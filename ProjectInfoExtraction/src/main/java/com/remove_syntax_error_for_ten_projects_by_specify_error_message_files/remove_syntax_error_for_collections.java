...
public class remove_syntax_error_for_collections {
    public static void main(String[] args) throws IOException {
        long startTime = System.currentTimeMillis();
        String package_name = "org.apache.commons.collections4";
        String Project_Basic_Dir = Config.BASE_DIR + "/experiment_results/TenProjects/commons-collections-master";
        String syntaxErrorFile = Config.CURRENT_DIR + "/saved_data/commons_collections_syntax_error_log.txt";
