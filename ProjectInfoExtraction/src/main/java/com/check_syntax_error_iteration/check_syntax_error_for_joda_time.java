...
public class check_syntax_error_for_joda_time {
    public static void main(String[] args) throws IOException {
        ...
        String projectDir = Config.BASE_DIR + "/experiment_results/TenProjects/joda-time-main";
        String syntaxErrorFile = Config.CURRENT_DIR + "/saved_data/syntax_error_log_joda_time.txt";
