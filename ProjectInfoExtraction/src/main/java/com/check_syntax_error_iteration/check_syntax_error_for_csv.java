...
public class check_syntax_error_for_csv {
    public static void main(String[] args) throws IOException {
        ...
        String syntaxErrorFile = Config.CURRENT_DIR + "/saved_data/syntax_error_log_csv.txt";
        String filesWithSyntaxErrorCsv = Config.CURRENT_DIR + "/saved_data/syntax_error_results/files_with_syntax_error_csv.csv";
