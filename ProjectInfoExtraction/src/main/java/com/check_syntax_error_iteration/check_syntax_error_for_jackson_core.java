...
public class check_syntax_error_for_jackson_core {
    public static void main(String[] args) throws IOException {
        long startTime = System.currentTimeMillis();
        String projectDir = Config.BASE_DIR + "/experiment_results/TenProjects/jackson-core-2.19";
        String syntaxErrorFile = Config.CURRENT_DIR + "/saved_data/syntax_error_log_jackson_core.txt";
